...
def search():
    ...
    if request.args:
        ...
        search_place_of_birth = request.args['search_place_of_birth']
        ...
        with open('json.txt', 'r', encoding='utf-8') as data:
            ...
            for line in splited_lines:
                print(line)
                if search_age in line:
                    if search_place_of_birth in line:
                        print(line)
                        result = result + line + '}' + '\n'
        ...
        return render_template('search.html', search_age=search_age,
                               search_place_of_birth=search_place_of_birth)
